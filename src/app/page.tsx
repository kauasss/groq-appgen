      ...
      <div className="flex w-full max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-start text-sm text-gray-600">
            {history[historyIndex]?.usage && (
              <span>
                {(history[historyIndex].usage.total_time * 1000).toFixed(0)}ms • {Math.round(history[historyIndex].usage.total_tokens / history[historyIndex].usage.total_time)} tokens/sec • <a target='_blank' className='underline' href="https://console.groq.com/docs/models">llama-3.3-70b-specdec</a>
              </span>
            )}
          </div>
        </div>
